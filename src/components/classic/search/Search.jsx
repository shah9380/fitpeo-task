...
const Search = () => {
  return (
    <div className='flex justify-center items-center border flex-grow gap-2 rounded-md bg-[#292B2F] border-black w-fit px-2 py-1'><svg className='w-4 h-4' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
